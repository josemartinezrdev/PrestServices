...
public class EmpresaController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable int id, @RequestBody Empresa newEmpresa) {
        return ResponseEntity.ok(service.update(id, newEmpresa));
    }
