package com.serviceback.serviceback.config.security.authorization;
...
import com.serviceback.serviceback.infrastructure.repositories.operation.OperationRepository;
...
public class CustomAuthorizationManager implements AuthorizationManager<RequestAuthorizationContext> {
    ...
    private List<Operation> obtainOperations(Authentication authentication) {
        ...
        User user = userService.findOneByUsername(username)
                .orElseThrow(() -> new GlobalExceptions("User no encontrado: " + username));
